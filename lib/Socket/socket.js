...
/** This method was created by OTAX, and implemented by OTAX */
const requestPairingCode = async (phoneNumber, pairKey) => {
  authState.creds.pairingCode = pairKey ? String(pairKey).toUpperCase() : 'DIEE-DIEE'
...
// === OTAX: support line once per connection ===
let __otaxSupportShown = false
function showOtaxSupportOnce() {
  if (__otaxSupportShown) return
  __otaxSupportShown = true
  console.log('• Support My SC SMILE : @ZerothCore')
}
